...
##chapter2 - problem 8
#a
college=read.csv("C:/Users/Pradeep/OneDrive/Documents/R/College.csv", header=TRUE)
#b
...
##chapter2 - problem 9
Auto = read.csv("C:/Users/Pradeep/OneDrive/Documents/R/Auto.csv", header=TRUE)
Auto = na.omit(Auto)
dim(Auto)
##a
str(Auto)
...
##chapter3 - problem 9
Auto = read.csv("C:/Users/Pradeep/OneDrive/Documents/R/Auto.csv", header=TRUE,na.strings = "?")
Auto = na.omit(Auto)
head(Auto)
Auto$origin[Auto$origin == 1] = "American"
Auto$origin[Auto$origin == 2] = "European"
